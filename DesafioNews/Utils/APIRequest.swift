...
class APIRequest {
    ...
    private static let basePath = "https://mesa-news-api.herokuapp.com/v1/client/news/highlights"
    
    /// Chave de acesso à API
    private static let key = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MjU5LCJlbWFpbCI6ImRpbWFzLmdhYnJpZWxAenJvYmFuay5jb20uYnIifQ.a3j7sRx8FIedZCfDGLocduOYpcibfIenX7TVJjv6Sis"

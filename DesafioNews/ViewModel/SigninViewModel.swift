...
class SigninViewModel {
    ...
    private func request(components: [String: Any]){
        networkRequest?.request(responseType: Bearer.self, method: .post, endpoint: RequestEndpoint.signin, components: components, key: nil, completionHandler: { [weak self] (result) in
